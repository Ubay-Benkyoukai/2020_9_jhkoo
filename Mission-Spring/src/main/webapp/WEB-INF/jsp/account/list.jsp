    ...
    <div class="container">
        ...
        <div class="row items-container clearfix">
        	...
        	<div class="item">
                <div class="inner-box">
                	<div class="image-content text-center">
                        ...
                        <h6>決済毎に最大2%積立! <br>「HANA-one」カード <br><br></h6>
                        <input type="button" value="見に行く" class="btn-style-one" onclick="goCardList()">
            ...
            <div class="item">
                <div class="inner-box">
                	<div class="image-content text-center">
                    	<img src="${pageContext.request.contextPath }/resources/assets/images/card2.png" class="card-img-top" alt="..." width="275" height="160">
                    
                        <h6>プレミアムサービス提供! <br>「HANA-Premium」カード <br><br></h6>
                        <input type="button" value="見に行く" class="btn-style-one" onclick="goCardList()">
