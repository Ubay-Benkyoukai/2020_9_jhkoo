...
<div class="container">
  <h3>${ month - 1 }月の内訳を照会中です</h3>
  <div class="btn-group" style="float:left;">
    <button type="button" class="btn btn-style-one" onclick="goMonthAgo()">${ month - 2 }月の内訳を見る</button>
    <c:if test="${ month - 1 != nowMonth }">
    <button type="button" class="btn btn-style-one" onclick="goMonthAhead()">${ month }月の内訳を見る</button>    
    </c:if>
